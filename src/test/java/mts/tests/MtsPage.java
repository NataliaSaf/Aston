...
public class MtsPage {
    ...
    By phoneInput = By.cssSelector("#connection-phone");
    By sumInput = By.cssSelector("#connection-sum");
    By emailInput = By.cssSelector("#connection-email");
    By continueButton = By.cssSelector("#pay-connection .button__default");

    //Метод для нажатие на кнопку сохранения cookie
